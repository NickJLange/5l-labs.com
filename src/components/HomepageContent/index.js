              ...
              {homepageConfig.products.map((product, idx) => (
                <div key={idx} className="col col--6 margin-bottom--md">
                  <div className="card shadow--md h-100">
                    <div className="card__header">
                      <h3>{product.link ? <Link {...getLinkProps(product.link)}>{product.title}</Link> : product.title}</h3>
                    </div>
                    ...
                    {product.link && (
                      <div className="card__footer">
                        <Link {...getLinkProps(product.link)} className="button button--outline button--primary button--block" aria-label={`Learn more about ${product.title}`}>Learn More</Link>
                      </div>
                    )}
                  </div>
                </div>
