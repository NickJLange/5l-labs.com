...
import Link from '@docusaurus/Link'; // Optimized for client-side routing
      ...
      <div className="text--center padding-horiz--md">
        ...
        <div className="card shadow--md">
          <div className="card__header">
            ...
            <small>{new Date(latestPost.date).toLocaleDateString('en-US') /* Explicit locale for stable hydration */}</small>
          </div>
