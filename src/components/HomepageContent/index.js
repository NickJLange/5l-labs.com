              ...
              {homepageConfig.products.map((product, idx) => (
                <div key={idx} className="col col--6 margin-bottom--md">
                  <div className="card shadow--md h-100">
                    ...
                    {product.link && (
                      <div className="card__footer">
                        <a href={product.link} target="_blank" rel="noopener noreferrer" className="button button--outline button--primary button--block" aria-label={`Learn more about ${product.title}`}>Learn More</a>
                      </div>
                    )}
                  </div>
                </div>
